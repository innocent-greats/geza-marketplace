class Strings {
  //splash screen
  static String appName = 'Geza BeautyApp';
  static String loading = 'Loading...';

  //onBoard screen
  static const String title1 = 'Experienced in Beautifying';
  ...
  static const String title2 = 'Rewarded Services';
  static const String subTitle2 =
      'Aenean leoigula porttitor eu,consequat vitae eleifend acenimliquam lorem ante dapibus in viverra quis feugiat';
  static const String title3 = 'Trained & Skillful Staffs';
  static const String subTitle3 =
      'Aenean leoigula porttitor eu,consequat vitae eleifend acenimliquam lorem ante dapibus in viverra quis feugiat';
  static String getStarted = 'Get Started';

  //intro screen
  static String beautyParlourBookingApp = 'Beauty Marketplace ';
  ...
  static String appointed = 'Appointed';
  static String profile = 'Profile';

  //home Screen
  static String beautyParlour = 'Geza';
  static String spaFacialMakeup = 'Spa, Facial, Makeup';
  static String popularBeautyParlour = 'Trending Styles';
  ...
  static String showSearchResult = 'Show Search Result';
  static String book = 'Book';
  static String userRequest = 'User Request';
  static String accept = 'Accept';
  static String request = 'Request';
  static String appointmentHistory = 'Appointment History';
  static String notifications = 'Notifications History';
  //parlour details screen
  ...
  static String chooseYourBeautyExpert = 'Choose Your Beauty Expert';
  ...
  static String mobileBanking = 'ECOCASH / ONEMONEY / TELECASH / OMARI';
  ...
  static String demoHolderName = 'INNOCENT GREATS';
  ...
  //near by screen
  static String yourNearBy = 'Your Nearby';
