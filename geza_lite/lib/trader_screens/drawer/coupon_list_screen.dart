...
import 'package:geza_lite/trader_screens/add_new_coupon_screen.dart';
import 'package:geza_lite/widgets/bg_image_widget.dart';
import 'package:geza_lite/data/coupon.dart';
      ...
      children: [
        GestureDetector(
          child: Container(
            ...
            child: Center(
              child: Text(
                '${ProvicerStrings.addNewCoupon.toUpperCase()} +',
                style: TextStyle(
                    color: Colors.white,
