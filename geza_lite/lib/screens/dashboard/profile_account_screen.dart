...
class ProfileAccountScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint('ProfileAccountScreen Get.arguments: $user\n');
    debugPrint('ProfileAccountScreen Get.arguments: ${user.id}\n');
    // debugPrint('ProfileAccountScreen user: ${_authController.person!.id}\n');
  ...
  addImageWidget(BuildContext context, controller, user) {
    debugPrint('ProfileAccountScreen user .arguments: $user\n');
        ...
        Container(
            ...
            child: user.profileImagePathLocation == null
                ...
                : CircleAvatar(
                    radius: 60.0,
                    backgroundImage:
                        NetworkImage(user.profileImagePathLocation.toString()),
                  )),
        Positioned(
          right: 0,
          bottom: 20,
